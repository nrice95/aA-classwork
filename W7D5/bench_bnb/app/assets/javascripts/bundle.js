...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.login = _util_session_api_util__WEBPACK_IMPORTED_MODULE_2__["login"]; //TEST

  window.signup = _util_session_api_util__WEBPACK_IMPORTED_MODULE_2__["signup"]; //TEST

  window.logout = _util_session_api_util__WEBPACK_IMPORTED_MODULE_2__["logout"]; //TEST
